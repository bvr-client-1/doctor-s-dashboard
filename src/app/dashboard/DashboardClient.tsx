...
function StatusBadge({ status }: { status: string }) {
  ...
  switch (status) {
    case "Confirmed":
      return (
        <span
          className={`${base} bg-emerald-50 text-emerald-700 ring-1 ring-emerald-600/20`}
        >
    ...
    case "Cancelled":
      return (
        <span
          className={`${base} bg-red-50 text-red-700 ring-1 ring-red-600/20`}
        >
    ...
    default:
      return (
        <span
          className={`${base} bg-amber-50 text-amber-700 ring-1 ring-amber-600/20`}
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-healthcare-200 text-sm mt-0.5">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2 bg-white/10 rounded-full px-4 py-2 backdrop-blur-sm">
                ...
                <span className="text-xs font-medium text-healthcare-100">
                  Live
                </span>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard
            ...
            sub={isDemo ? "Demo data" : "All time"}
          />
          <StatCard
            icon="⏳"
            value={stats.pending}
            label="Pending Confirmations"
            sub={isDemo ? "Demo data" : "Requires action"}
          />
          <StatCard
            icon="📞"
          ...
          <StatCard
            ...
            sub={isDemo ? "Demo data" : "Active departments"}
          />
        </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 sm:p-16">
              <div className="max-w-md mx-auto text-center">
                <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-healthcare-50 to-healthcare-100 flex items-center justify-center">
                  <svg
                    className="w-10 h-10 text-healthcare-400"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={1.5}
                ...
                <table className="min-w-full divide-y divide-gray-100">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {filtered.map((appt) => (
                      <tr
                        key={appt.id}
                        className="hover:bg-healthcare-50/40 transition-colors"
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 max-w-[140px] truncate">
                          {appt.reason || "—"}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-healthcare-200 text-sm mt-1 max-w-md">
                  Connect your AI voice calling system to start receiving real
